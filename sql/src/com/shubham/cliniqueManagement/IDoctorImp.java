...
public class IDoctorImp implements IDoctor {
	...
	@Override
	public void showSpecificDetails(Connection con, Statement stmt, BufferedReader br)
	...
	@Override
	public void manager(BufferedReader br, Connection con, Statement stmt) throws Exception {
		int a = options(br);
		switch (a) {
		case 1:
			newEntry(con, stmt, br);
			break;
		case 2:
			update(con, stmt, br);
			break;
		case 3:
			...
			break;
		case 4:
			showSpecificDetails(con, stmt, br);
			break;
		case 5:
			delete(con, stmt, br);
			break;
